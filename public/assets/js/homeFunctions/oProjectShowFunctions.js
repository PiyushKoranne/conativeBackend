const uploaderElements = document.querySelectorAll(".home-o-project-uploader");
uploaderElements.forEach(element => {
	element.addEventListener("change", readURL)
})

const editElement = document.querySelector("#home-o-project-edit-form");
