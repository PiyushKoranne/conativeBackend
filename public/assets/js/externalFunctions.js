const elements = document.querySelectorAll(".life-at-conative-event");
elements.forEach(element => {
    element.addEventListener('click', geteditform);
});

const elements1 = document.querySelectorAll(".add-new-lifeatconative-event");
